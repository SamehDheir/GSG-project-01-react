      ...
      <div className="flex flex-col lg:items-center md:flex-row gap-10 mt-10 px-5 md:px-20">
        <div className="hidden md:block w-1/2">
          <img
            src={loginImg}
            alt="Login"
            className="w-full h-full lg:h-140 rounded-lg"
          />
        </div>
        ...
        <div className="w-full md:w-1/2 max-w-md">
          ...
          <form className="mt-8 space-y-6">
            ...
            <div>
              <button
                type="submit"
                className="w-full bg-primary text-white py-4 rounded hover:bg-[#DB3333] transition-colors duration-300"
              >
                Create Account
              </button>
              <button
                type="submit"
                className="w-full flex justify-center items-center bg-transparent border mt-4 py-4 rounded hover:bg-[#DB3333] hover:text-white transition-colors duration-300"
              >
                <span className="mr-3">
                  <svg
                    viewBox="-0.5 0 48 48"
          ...
          <p className="text-center mt-8">
            ...
            <a href="#" className="ml-5 border-b-1 pb-1">
              Log in
            </a>
          </p>
        </div>
