      ...
      <div className="flex flex-wrap justify-center sm:justify-between item-center my-10 text-[16px] text-base/7">
        {products.map((product) => (
          <div key={product.id} className="mb-15">
            <div className="relative hover:scale-110 transition-transform duration-300 cursor-pointer w-94 h-80 md:w-[300px] md:h-[250px] mb-3">
              <img
                src={product.image}
                alt={product.name}
                className="w-100 h-full bg-gray-100 p-10 object-cover rounded"
              />
            ...
            <div className="flex gap-0.5 items-center">
              <h5 className="text-primary mr-3">${product.price} </h5>
