  ...
  return (
    <div className="px-12 my-15">
      ...
      <div className="flex flex-wrap gap-7 w-full">
        <div className="w-full sm:w-[680px] h-60 lg:h-[430px] relative bg-black">
          <img src={PlayStaution} alt="" className="w-full h-full rounded" />
        ...
        <div className="w-full sm:w-[680px] ">
          <div className="h-60 sm:h-[200px] mb-7 relative  bg-black">
            <img
              src={Women}
              alt=""
              className="w-full h-full rounded object-contain  object-right"
            />
            <div className="absolute bottom-3 left-5 text-white">
          ...
          <div className=" flex flex-wrap gap-7 relative  ">
            <div className="w-full sm:w-[325px] h-[200px]  bg-black">
              <img
                src={Speakers}
                alt=""
                className="w-full h-full rounded  object-contain "
              />
              <div className="absolute  bottom-60 sm:bottom-3 left-5 sm:left-93 text-white">
                <h4 className="text-lg font-bold">Speakers 5</h4>
      ...
      <div className="flex flex-wrap justify-center items-center text-center gap-10 lg:gap-60 my-20">
        <div className="flex flex-col items-center text-center">
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="size-15 mb-4 bg-black text-white rounded-full p-2 border-10 border-gray-500"
          >
            <path
              strokeLinecap="round"
