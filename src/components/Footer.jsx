      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
        <div className="space-y-4 min-w-[180px]">
          ...
          <div className="relative mt-3 w-full max-w-xs">
            <input
              type="email"
              className="w-full border-2 border-white bg-transparent rounded text-white pr-10 pl-3 py-2 text-sm sm:text-base placeholder:text-gray-300"
            ...
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="w-5 h-5 absolute right-2 top-1/2 -translate-y-1/2 text-white cursor-pointer"
            >
              <path
                strokeLinecap="round"
        ...
        <div className="space-y-2 min-w-[150px]">
          ...
          <p className="text-sm sm:text-base">Login / Register</p>
          <p className="text-sm sm:text-base">Cart</p>
        ...
        <div className="space-y-2 min-w-[150px]">
          ...
          <p className="text-sm sm:text-base">Terms Of Use</p>
